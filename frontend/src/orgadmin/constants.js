...
export const STATIC_NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { id: 'module-requests', icon: '🔑', label: 'Module Requests' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ndr-cleanup',     icon: '📮', label: 'Bounce Cleanup'  },  // repairs NDRs stored as replies
  ...
  // 'Modules' group is injected here dynamically — see buildNavGroups()
  {
    ...
    items: [
      ...
      { id: 'assessment',   icon: '📊', label: 'Assessment & Baseline' },
...
export const TAB_META = {
  ...
  'module-requests': { title: 'Module Requests', desc: 'Review and approve members requesting module access for colleagues' },
  ...
  'ndr-cleanup':     { title: 'Bounce Cleanup',   desc: 'Find undeliverable messages that were stored as prospect replies — remove the phantom reply, revert the stage, and record the bounce' },
  'custom-fields': { title: 'Custom Fields', desc: 'Define org-level custom fields for prospects, accounts, contacts, and deals' },
  assessment: { title: 'Assessment & Baseline', desc: 'Read-only CRM assessment: schema discovery, stage mapping approval, immutable baseline capture, and the findings report' },
  ...
  'action-ai':   { title: 'Actions AI',    desc: 'Configure how AI generates and enhances actions across modules' },
  'ai-usage':    { title: 'AI Usage',      desc: 'Token usage and AI cost breakdown for your organisation' },
