...
app.use('/api/list-mappings', require('./routes/list-mappings.routes'));
...
app.use('/api/module-requests', require('./routes/moduleAccessRequests.routes'));
...
app.listen(PORT, () => {
  ...
  try {
    ...
    if (backgroundEnabled) {
      ...
      require('./jobs/whatsappMediaJob');                    // queue processor
      require('./jobs/whatsappMediaJob').startScheduler();   // expiry sweep
    }
