...
const PLAYS = {
  ...
  prospecting: [
    ...
    // Research (4)
    {
      ...
      channel: 'internal_task', due_offset_days: 2, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
    ...
    // Outreach (5)
    {
      ...
      channel: 'email', due_offset_days: 1, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'linkedin', due_offset_days: 1, priority: 'medium', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'email', due_offset_days: 4, priority: 'medium', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'phone', due_offset_days: 7, priority: 'medium', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'email', due_offset_days: 10, priority: 'low', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    ...
    // Engaged (4)
    {
      ...
      channel: 'email', due_offset_days: 0, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'email', due_offset_days: 1, priority: 'medium', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
    ...
    },
    {
      ...
      channel: 'email', due_offset_days: 3, priority: 'medium', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    ...
    // RAL (5)
    {
      ...
      channel: 'meeting', due_offset_days: 2, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
    ...
    // Nurture (4)
    {
      ...
      channel: 'email', due_offset_days: 2, priority: 'medium', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'linkedin', due_offset_days: 3, priority: 'low', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'email', due_offset_days: 90, priority: 'low', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'internal_task', due_offset_days: 90, priority: 'low', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
  ],
  ...
  sales: [
    ...
    // Sales Qualified (5)
    {
      ...
      channel: 'meeting', due_offset_days: 5, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'internal_task', due_offset_days: 3, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'email', due_offset_days: 7, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'document', due_offset_days: 7, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
    ...
    },
    {
      ...
      channel: 'internal_task', due_offset_days: 5, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    ...
    // Commercial & Negotiation (6)
    {
      ...
      channel: 'document', due_offset_days: 3, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'meeting', due_offset_days: 3, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
    ...
    },
    {
      ...
      channel: 'email', due_offset_days: 2, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    ...
    // Contracts (5)
    {
      ...
      channel: 'document', due_offset_days: 2, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
    ...
    },
    {
      ...
      channel: 'document', due_offset_days: 1, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
    ...
    },
    {
      ...
      channel: 'internal_task', due_offset_days: 1, priority: 'low', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
  ],
  ...
  clm: [
    ...
    },
    {
      ...
      channel: 'email', due_offset_days: 3, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
    ...
    // Active (13) — all trigger_mode: 'stage_change', grouped by sort_order band
    {
      ...
      channel: 'document', due_offset_days: 2, priority: 'medium', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
    ...
    },
    {
      ...
      channel: 'internal_task', due_offset_days: 2, priority: 'medium', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'meeting', due_offset_days: 14, priority: 'medium', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
      ...
      channel: 'internal_task', due_offset_days: 7, priority: 'low', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
    ...
    },
    {
      ...
      channel: 'meeting', due_offset_days: 1, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
  ...
  service: [
    ...
    },
    {
      ...
      channel: 'internal_task', due_offset_days: 0, priority: 'high', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
    {
    ...
    },
    {
      ...
      channel: 'email', due_offset_days: 7, priority: 'low', trigger_mode: 'stage_change', generation_mode: 'template', execution_type: 'manual',
    },
