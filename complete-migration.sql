-- ============================================================
-- OUTLOOK EMAIL INTEGRATION - COMPLETE DATABASE MIGRATION
-- ============================================================
...
-- ============================================================
-- TABLE 1: oauth_tokens
-- Stores OAuth access and refresh tokens for Outlook
-- ============================================================
...
-- ============================================================
-- TABLE 2: email_sync_history
-- Tracks email synchronization history and status
-- ============================================================
...
-- Add email source tracking to existing actions table (if not exists)
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
...
-- Verify by running:
-- \dt                    (list all tables)
-- \d oauth_tokens        (describe oauth_tokens table)
-- \d email_sync_history  (describe email_sync_history table)
-- \d users               (check new columns)
-- \d actions             (check new columns)
-- ============================================================
